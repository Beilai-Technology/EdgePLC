...
![EdgePLC A款 (2)](EdgePLC BL234说明书V1.1-images/image2.jpeg)
...
![](EdgePLC BL234说明书V1.1-images/image1.png)
...
![F:/2025_9/EdgePLC/标签外壳/标准款清晰图片.png标准款清晰图片](EdgePLC BL234说明书V1.1-images/image4.png)![F:/2025_9/EdgePLC/标签外壳/A款清晰图片.pngA款清晰图片](EdgePLC BL234说明书V1.1-images/image5.png)
...
![EdgePLC A款 (10)](EdgePLC BL234说明书V1.1-images/image6.png)![](EdgePLC BL234说明书V1.1-images/image7.png)
...
![e2c8802fdadeb1e5530381aefa943291_origin(1)](EdgePLC BL234说明书V1.1-images/image8.png)。
...
![](EdgePLC BL234说明书V1.1-images/image9.png)

串口助手发送数据

![](EdgePLC BL234说明书V1.1-images/image10.png)

终端界面收到数据

![](EdgePLC BL234说明书V1.1-images/image11.png)
...
![](EdgePLC BL234说明书V1.1-images/image12.png)

![](EdgePLC BL234说明书V1.1-images/image13.png)

通过左边文件夹页面在usr/demo/文件夹下，新建ion文件夹，把N板识别文件复制进去

![](EdgePLC BL234说明书V1.1-images/image14.png)
...
root@bliiot:/# chmod +x BEILAI_N_PLC_234_V1.0_20260522.bin

root@bliiot:/# ./BEILAI_N_PLC_234_V1.0_20260522.bin
...
![](EdgePLC BL234说明书V1.1-images/image15.png)

![](EdgePLC BL234说明书V1.1-images/image17.png)
...
![](EdgePLC BL234说明书V1.1-images/image23.png)
...
![](EdgePLC BL234说明书V1.1-images/image25.png)

将DI24（即为24通道）短接

![](EdgePLC BL234说明书V1.1-images/image27.png)
...
![](EdgePLC BL234说明书V1.1-images/image29.png)
...
![](EdgePLC BL234说明书V1.1-images/image30.png)

root@bliiot:/# ion set 4000 10 //通过address设置输出10mA

root@bliiot:/# ion get 4000 //通过address查看

![](EdgePLC BL234说明书V1.1-images/image31.png)

通过高精度万用表直流电流档查看实际值与设置值是否相符,若显示值与理论值的偏差在允许误差范围内，即视为校准通过。

对应的N4086差分输出电压类似。

![](EdgePLC BL234说明书V1.1-images/image32.png)
...
![](EdgePLC BL234说明书V1.1-images/image33.png)
...
![](EdgePLC BL234说明书V1.1-images/image34.png)

对应的N3083单端输入电压类似。

![](EdgePLC BL234说明书V1.1-images/image35.png)
...
![](EdgePLC BL234说明书V1.1-images/image36.png)

使用电阻箱设置阻值对应温度值改变到合适的范围，若显示值与理论值（对应pt100/1000温度阻值对应表）的偏差在允许误差范围内，即视为校准通过。

对应的N5042、N5043、 N5044类似。

![](EdgePLC BL234说明书V1.1-images/image37.png)

![](EdgePLC BL234说明书V1.1-images/image38.png)

![](EdgePLC BL234说明书V1.1-images/image39.png)
...
![](EdgePLC BL234说明书V1.1-images/image40.png)

3)  **量程模式修改**

通过ion help命令，可以看到config的命令格式。

![](EdgePLC BL234说明书V1.1-images/image41.png)

在终端中执行以下命令，以获取设备当前的运行状态及模式设置指令：

root@bliiot:/# ion getmode

![](EdgePLC BL234说明书V1.1-images/image42.png)
...
![EdgePLC A款 (1)](EdgePLC BL234说明书V1.1-images/image43.jpeg)
...
![EdgePLC A款 (1)](EdgePLC BL234说明书V1.1-images/image44.png)
...
![](EdgePLC BL234说明书V1.1-images/image45.png)

此时ETH2应显示为设定的静态IP地址192.168.1.122。

通过ETH2进行SSH登录验证。

![](EdgePLC BL234说明书V1.1-images/image46.png)
...
root@BL234-bliiot:~# udhcpc -i eth2

udhcpc: started, v1.30.1

udhcpc: sending discover

udhcpc: sending select for 192.168.1.122
...
![EdgePLC A款 (1)](EdgePLC BL234说明书V1.1-images/image47.png)
...
![](EdgePLC BL234说明书V1.1-images/image48.png)
...
![](EdgePLC BL234说明书V1.1-images/image49.png)
...
6.  可以看到读取的速度。
    ...
    ![](EdgePLC BL234说明书V1.1-images/image50.png)
...
![](EdgePLC BL234说明书V1.1-images/image51.png)

9.  重复B~F操作，没有问题说明USB端口正常。

![](EdgePLC BL234说明书V1.1-images/image52.png)

## HDMI接口

![EdgePLC A款 (1)](EdgePLC BL234说明书V1.1-images/image53.png)
...
![c8c1b31cf4c96155d490e919f7fb7263_compress](EdgePLC BL234说明书V1.1-images/image54.png)

调试接口如图。可通过该端口进入设备系统。

## SIM卡插槽

![c8c1b31cf4c96155d490e919f7fb7263_compress](EdgePLC BL234说明书V1.1-images/image55.png)

SIM卡槽如图所示。

## SD卡插槽

![c8c1b31cf4c96155d490e919f7fb7263_compress](EdgePLC BL234说明书V1.1-images/image56.png)
...
![](EdgePLC BL234说明书V1.1-images/image57.png)
...
4.  可以看到工作状态下的（负载）写入的速度。
    ...
    ![](EdgePLC BL234说明书V1.1-images/image58.png)
...
7.  可以看到工作状态下读取的速度。
    ...
    ![](EdgePLC BL234说明书V1.1-images/image59.png)
...
![](EdgePLC BL234说明书V1.1-images/image60.png)

## 重启按钮

![c8c1b31cf4c96155d490e919f7fb7263_compress](EdgePLC BL234说明书V1.1-images/image61.png)
...
![](EdgePLC BL234说明书V1.1-images/image62.png)

stty -F /dev/ttyUSB1 ispeed 115200 ospeed 115200 cs8 raw -echo
//设置串口

![](EdgePLC BL234说明书V1.1-images/image63.png)

查信号 20以上 ：

cat /dev/ttyUSB1 & echo -e "AT+CSQ/r" /> /dev/ttyUSB1（输入两遍）

![](EdgePLC BL234说明书V1.1-images/image64.png)

查是4G模块否能正常和SIM卡通讯：

echo -e "AT+CPIN?/r" /> /dev/ttyUSB1

![](EdgePLC BL234说明书V1.1-images/image65.png)
...
![](EdgePLC BL234说明书V1.1-images/image66.png)
...
![](EdgePLC BL234说明书V1.1-images/image67.png)
...
![](EdgePLC BL234说明书V1.1-images/image68.png)
...
![](EdgePLC BL234说明书V1.1-images/image69.png)
...
![](EdgePLC BL234说明书V1.1-images/image70.png)

ifconfig /#查看wlan0有无IP

![](EdgePLC BL234说明书V1.1-images/image71.png)

最后ping百度测试：

ping www.baidu.com （百度域名不一定成功转IP，使用百度IP）

![](EdgePLC BL234说明书V1.1-images/image72.png)
...
![](EdgePLC BL234说明书V1.1-images/image73.png)
...
![](EdgePLC BL234说明书V1.1-images/image74.png)

## SSH2登录

在使用网口登录前需设置对应网口的IP。此处以ETH2为例。此处ETH2已连接路由器，获取到的IP为192.168.2.107。电脑IP在2网段。

![](EdgePLC BL234说明书V1.1-images/image75.png)

点击创建连接，选择协议为SSH2，主机名填写为设备IP：192.168.2.107，端口22，用户名root，点击Connect连接。

![](EdgePLC BL234说明书V1.1-images/image76.png)

选择接受，即连接成功。

![](EdgePLC BL234说明书V1.1-images/image77.png)
...
![](EdgePLC BL234说明书V1.1-images/image78.png)

工具运行后会自动识别接入到PC端的Micro SD卡，如下图所示。

![](EdgePLC BL234说明书V1.1-images/image79.png)

将系统镜像拷贝至非中文路径的目录下。在PhoenixCard软件上点击“固件”选择目标镜像文件，接着选择“启动卡”，最后点击“烧卡”制作“启动卡”

![](EdgePLC BL234说明书V1.1-images/image80.png)

系统启动卡制作完成后，状态栏呈现绿色并打印如下信息。

![](EdgePLC BL234说明书V1.1-images/image81.png)
...
![](EdgePLC BL234说明书V1.1-images/image82.png)
...
![](EdgePLC BL234说明书V1.1-images/image83.png)

“量产卡”制作完成后，状态栏将会打印如下信息。

![](EdgePLC BL234说明书V1.1-images/image84.png)
...
![](EdgePLC BL234说明书V1.1-images/image85.png)
...
![](EdgePLC BL234说明书V1.1-images/image86.png)
...
![8aec9eb215acbbce3b8954b2e1062111_compress](EdgePLC BL234说明书V1.1-images/image87.png)![8aec9eb215acbbce3b8954b2e1062111_compress](EdgePLC BL234说明书V1.1-images/image88.png)

将卡扣垂直向下按压，直至其完全嵌入并锁定于导轨底部，即可完成安装。长导轨卡无需额外卡扣，因其内部已预设专用凹槽结构，可直接实现稳固连接。

![ac31d771be6b72005cba9ec2e46da2bc_compress](EdgePLC BL234说明书V1.1-images/image89.png)
