# EdgePLC BL246说明书V1.1

![image](EdgePLC BL246说明书V1.1-images/image44.jpeg)
![image](EdgePLC BL246说明书V1.1-images/image44.jpeg)
![image](EdgePLC BL246说明书V1.1-images/image33.png)
...
在工业自动化向“AI边缘计算+实时控制”深度融合的转型背景下，传统PLC面临智能计算的瓶颈，而通用工业计算机又难以满足高实时性控制的需求。EdgePLC BL246系列工业AI边缘控制器应运而生，旨在打破IT与OT的融合壁垒，提供真正意义上的“边缘AI控算一体”解决方案。

BL246系列采用“树莓派5核心处理器 + 分布式I/O扩展”的架构，树莓派5以Broadcom BCM2712为核心，基于四核Cortex-A76架构，在保障毫秒级实时控制的同时，搭配AI算力棒可具备强大的本地AI推理与数据处理能力。BL246系列接入树莓派软件生态，兼容主流开发工具、应用和硬件驱动库，同时拥有全球最大的爱好者社区，官方文档详尽，教程和开源项目极其丰富。

EdgePLC BL246工业AI边缘控制器深度融合实时控制、AI边缘智能、协议转换、远程运维与二次开发等功能，支持IEC 61131-3标准编程环境（OpenPLC/NexPLC/CODESYS）、IGH EtherCAT硬实时主站，并可扩展多达32块N系列分布式I/O模块，覆盖DI/DO/AI/AO/温度采集等多种信号类型。软件层面基于Ubuntu 20.04系统，集成Docker、Node-RED、Python/C++开发环境，以及YOLOv5/8+OpenCV等AI视觉工具栈，实现从数据采集、实时分析到智能决策的全流程闭环。
...
![image](EdgePLC BL246说明书V1.1-images/image11.png)
![image](EdgePLC BL246说明书V1.1-images/image101.png)

### 1.3技术参数

| 分类 | 参数 | 描述 |
|---|---|---|
| 系统 | 处理器型号 | Broadcom BCM2712 |
| 系统 | 处理器频率 | 四核 Arm Cortex-A76 主频： 2.4 GHz，带加密扩展，每核 512KB L2 缓存，2MB 共享 L3 缓存 |
| 系统 | GPU | GPU：VideoCore VII GPU，支持 OpenGL ES 3.1、Vulkan 1.2、4Kp60 HEVC 解码器 |
| 系统 | 内存 | 2/4/8/16GByte LPDDR4X |
| 系统 | 存储 | 8/16/32/64GByte eMMC |
| 电源 | 输入电压 | DC 12-24V |
| 电源 | 功耗 | 正常：318mA@12V（带4G模块），285mA@12V（不带4G模块） 最大：700mA@12V |
| 电源 | 反接防护 | 支持 |
| 网口 | 网口规格 | RJ-45 接口，2~3个，1个10/100/1000M、2个10/100M 自适应网口 |
| 网口 | 网口保护 | ESD ±4kV（接触），±8kV（空气）； |
| SIM卡 | 数量 | 1 |
| SIM卡 | 规格 | 抽屉式接口 |
| 串口（选配） | 串口数量 | 2*RS485 |
...
| 环境 | 工作温度、湿度 | -20～85℃，5～95% RH |
| 环境 | 存储温度、湿度 | -20～85℃，5～95% RH |
| 其他 | 外壳 | 铝合金外壳+不锈钢 |
| 其他 | 尺寸 | 110*92*38mm |
| 其他 | 防护等级 | IP30 |
| 其他 | 安装方式 | DIN35导轨安装 |
| 其他 | 系统 | Operating System: Raspberry Pi OS Kernel: Linux 6.6.78-v8-16k |
...
|---|---|---|---|---|---|---|
| CM5002000 | BCM2712 | 2.4GHz | x | 0GB (Lite) | 2GB | -20~85℃ |
| CM5002016 | BCM2712 | 2.4GHz | x | 16GB | 2GB | -20~85℃ |
| CM5002032 | BCM2712 | 2.4GHz | x | 32GB | 2GB | -20~85℃ |
| CM5004000 | BCM2712 | 2.4GHz | x | 0GB (Lite) | 4GB | -20~85℃ |
| CM5004016 | BCM2712 | 2.4GHz | x | 16GB | 4GB | -20~85℃ |
| CM5004032 | BCM2712 | 2.4GHz | x | 32GB | 4GB | -20~85℃ |
| CM5008000 | BCM2712 | 2.4GHz | x | 0GB (Lite) | 8GB | -20~85℃ |
| CM5008016 | BCM2712 | 2.4GHz | x | 16GB | 8GB | -20~85℃ |
| CM5008032 | BCM2712 | 2.4GHz | x | 32GB | 8GB | -20~85℃ |
| CM5016000 | BCM2712 | 2.4GHz | x | 0GB (Lite) | 16GB | -20~85℃ |
| CM5016016 | BCM2712 | 2.4GHz | x | 16GB | 16GB | -20~85℃ |
| CM5016032 | BCM2712 | 2.4GHz | x | 32GB | 16GB | -20~85℃ |
| CM5016064 | BCM2712 | 2.4GHz | x | 64GB | 16GB | -20~85℃ |
| CM5102000 | BCM2712 | 2.4GHz | PCB/ext | 0GB (Lite) | 2GB | -20~85℃ |
| CM5102016 | BCM2712 | 2.4GHz | PCB/ext | 16GB | 2GB | -20~85℃ |
| CM5102032 | BCM2712 | 2.4GHz | PCB/ext | 32GB | 2GB | -20~85℃ |
| CM5104000 | BCM2712 | 2.4GHz | PCB/ext | 0GB (Lite) | 4GB | -20~85℃ |
| CM5104016 | BCM2712 | 2.4GHz | PCB/ext | 16GB | 4GB | -20~85℃ |
| CM5104032 | BCM2712 | 2.4GHz | PCB/ext | 32GB | 4GB | -20~85℃ |
| CM5108000 | BCM2712 | 2.4GHz | PCB/ext | 0GB (Lite) | 8GB | -20~85℃ |
| CM5108016 | BCM2712 | 2.4GHz | PCB/ext | 16GB | 8GB | -20~85℃ |
| CM5108032 | BCM2712 | 2.4GHz | PCB/ext | 32GB | 8GB | -20~85℃ |
| CM5108064 | BCM2712 | 2.4GHz | PCB/ext | 64GB | 8GB | -20~85℃ |
| CM5116000 | BCM2712 | 2.4GHz | PCB/ext | 0GB (Lite) | 16GB | -20~85℃ |
| CM5116016 | BCM2712 | 2.4GHz | PCB/ext | 16GB | 16GB | -20~85℃ |
| CM5116032 | BCM2712 | 2.4GHz | PCB/ext | 32GB | 16GB | -20~85℃ |
| CM5116064 | BCM2712 | 2.4GHz | PCB/ext | 64GB | 16GB | -20~85℃ |
...
![image](EdgePLC BL246说明书V1.1-images/image93.png)
![image](EdgePLC BL246说明书V1.1-images/image92.png)
...
。
![image](EdgePLC BL246说明书V1.1-images/image91.png)
...
|---|---|---|---|---|---|---|
| 端口号 | 1 | 2 | 3 | 4 | 5 | 6 |
| 名称 | ttyACM0-A | ttyACM0-B | GND | ttyAMA2-A | ttyAMA2-B | GND |
...
![image](EdgePLC BL246说明书V1.1-images/image90.png)
...
![image](EdgePLC BL246说明书V1.1-images/image89.png)

设置完后重启设备通过指令查看

ls /dev/ttyA*

![image](EdgePLC BL246说明书V1.1-images/image88.png)

BL246中“ttyACM0-TX”和“ttyACM0-RX”表示一组RS485串口线。使用RS485串口时，将RS485线接至端口上，如x90模块中有ttyACM0和ttyAMA2两个串口，以ttyAMA2为例，其设备文件为/dev/ttyACM2；设置其波特率设为 115200，8N1，无校验位。
...
![image](EdgePLC BL246说明书V1.1-images/image87.png)

串口助手发送数据

![image](EdgePLC BL246说明书V1.1-images/image86.png)

终端界面收到数据

![image](EdgePLC BL246说明书V1.1-images/image85.png)
...
对应文件位置位于/ion文件夹下。实际请以文件为准。复制需要的bin文件到U盘。

![image](EdgePLC BL246说明书V1.1-images/image84.png)

![image](EdgePLC BL246说明书V1.1-images/image83.png)

![image](EdgePLC BL246说明书V1.1-images/image82.png)
...
![image](EdgePLC BL246说明书V1.1-images/image81.png)

![image](EdgePLC BL246说明书V1.1-images/image80.png)
...
![image](EdgePLC BL246说明书V1.1-images/image79.png)

root@bliiot:/# ion set 1000 1 //通过address设置输出1

root@bliiot:/# ion get 1000 //通过address查看

![image](EdgePLC BL246说明书V1.1-images/image78.png)
...
## 1、外接电源：将外接电源的正负极接到电源两端，以通道15为例，电源的接到模块的公共端（COM/0V），接到模块的 DI 输入端子。

## 2、灯亮，终端输入ion show查看已闭合。

型则公共端接，输入端子接。

![image](EdgePLC BL246说明书V1.1-images/image77.png)
...
![image](EdgePLC BL246说明书V1.1-images/image76.png)

将DI15（即为15通道）短接

![image](EdgePLC BL246说明书V1.1-images/image75.png)

观察N板灯亮情况，对应DI短接形成回路灯亮。对应的N1162、1321、1322类似。

干接点以N1163、N1323为例，短接即可和上述类似。

![image](EdgePLC BL246说明书V1.1-images/image74.png)

![image](EdgePLC BL246说明书V1.1-images/image73.png)

![image](EdgePLC BL246说明书V1.1-images/image72.png)

![image](EdgePLC BL246说明书V1.1-images/image71.png)

![image](EdgePLC BL246说明书V1.1-images/image70.png)

![image](EdgePLC BL246说明书V1.1-images/image69.png)

![image](EdgePLC BL246说明书V1.1-images/image68.png)

![image](EdgePLC BL246说明书V1.1-images/image67.png)

![image](EdgePLC BL246说明书V1.1-images/image66.png)

![image](EdgePLC BL246说明书V1.1-images/image65.png)

![image](EdgePLC BL246说明书V1.1-images/image64.png)

![image](EdgePLC BL246说明书V1.1-images/image63.png)

![image](EdgePLC BL246说明书V1.1-images/image62.png)

![image](EdgePLC BL246说明书V1.1-images/image61.png)

### 2.4 LED

![image](EdgePLC BL246说明书V1.1-images/image60.jpeg)
...
sudo nano /etc/NetworkManager/system-connections/static-eth0.nmconnection //修改静态地址配置文件

[connection] id=static-eth1 //要修改的网口连接id type=ethernet interface-name=eth1 //要修改的网口名称 autoconnect=true [ipv4] method=manual //设为手动获取IP addresses1=192.168.1.110/24,192.168.1.1 //修改的地址和网关 dns=8.8.8.8;1.1.1.1; [ipv6] method=auto //设置为自动获取IP

### 2.6网络接口

![image](EdgePLC BL246说明书V1.1-images/image59.png)
...
![image](EdgePLC BL246说明书V1.1-images/image58.png)
...
![image](EdgePLC BL246说明书V1.1-images/image57.png)

此时LINK灯亮。

### 2.7 USB接口

![image](EdgePLC BL246说明书V1.1-images/image56.png)
...
![image](EdgePLC BL246说明书V1.1-images/image55.png)
...
![image](EdgePLC BL246说明书V1.1-images/image54.png)
...
![image](EdgePLC BL246说明书V1.1-images/image53.png)
...
![image](EdgePLC BL246说明书V1.1-images/image52.png)

重复B~F操作，没有问题说明USB端口正常。

![image](EdgePLC BL246说明书V1.1-images/image51.png)

### 2.8 HDMI接口

![image](EdgePLC BL246说明书V1.1-images/image50.png)
...
![image](EdgePLC BL246说明书V1.1-images/image49.png)

调试接口如图。可通过该端口进入设备系统。

### 2.10 SIM卡插槽

![image](EdgePLC BL246说明书V1.1-images/image48.png)

SIM卡槽如图所示。

### 2.11 SD卡插槽

![image](EdgePLC BL246说明书V1.1-images/image47.png)
...
![image](EdgePLC BL246说明书V1.1-images/image46.png)

系统识别到存储介质包含两个有效分区，后续读写性能测试将限定在系统的临时文件夹（/tmp）路径下进行”，并且可直观读取到该存储设备的实际物理容量。
...
fio --filename=/tmp/testfile --ioengine=psync --rw=write --bs=1024k --size=1G --numjobs=1 --thread --group_reporting --name=write_job --ramp_time=1 --direct=1

可以看到工作状态下的（负载）写入的速度。

![image](EdgePLC BL246说明书V1.1-images/image45.png)
...
fio --filename=/tmp/testfile --ioengine=psync --rw=read --bs=1024k --size=1G --numjobs=1 --thread --group_reporting --name=read_job --ramp_time=1 --direct=1

可以看到工作状态下读取的速度。

![image](EdgePLC BL246说明书V1.1-images/image43.png)
...
![image](EdgePLC BL246说明书V1.1-images/image42.png)

### 2.12重启按钮

![image](EdgePLC BL246说明书V1.1-images/image41.png)
...
![image](EdgePLC BL246说明书V1.1-images/image40.png)
...
AT+QCFG="USBNET",1 //echo -e "AT+QCFG=\"USBNET\",1\r" | sudo tee /dev/ttyUSB1

使用EC200模块，还需增加一条命令才可联网：

AT+QNETDEVCTL=3,1,1 //echo -e "AT+QNETDEVCTL=3,1,1\r" | sudo tee /dev/ttyUSB1

![image](EdgePLC BL246说明书V1.1-images/image39.png)

查看IP有没有多余的以太网节点，一般是ETH4(自带Wi-Fi模块的核心板ETH2)。

![image](EdgePLC BL246说明书V1.1-images/image38.png)

然后通过ping www.baidu.com /8.8.8.8-I eth2 测试上网。

![image](EdgePLC BL246说明书V1.1-images/image37.png)
...
连接Wi-Fi网络默认使用核心板板载天线，如果使用外部天线需要在/boot/firmware/config.txt 中添加。
...
![image](EdgePLC BL246说明书V1.1-images/image36.png)

sudo nmcli dev wifi connect <SSID> password <password>

//将<SSID>替换为你的Wi-Fi名称，<password>替换为你的Wi-Fi密码

![image](EdgePLC BL246说明书V1.1-images/image35.png)
...
![image](EdgePLC BL246说明书V1.1-images/image34.png)

可通过ifconfig查看获取到的IP地址，执行如下命令测试网络功能是否正常。

ping www.baidu.com -I wlan0

或者用图形界面连接，输入sudo nmtui指令进入界面，选择Activate a connect进入Wi-Fi选择界面，选中Wi-Fi输入密码即可连接。

![image](EdgePLC BL246说明书V1.1-images/image32.png)

![image](EdgePLC BL246说明书V1.1-images/image31.png)

执行如下命令测试网络功能是否正常。

ping www.baidu.com -I wlan0

![image](EdgePLC BL246说明书V1.1-images/image30.png)
...
sudo nmcli connection add type wifi ifname wlan0 con-name my-hotspot autoconnect yes ssid "Myhotspot" \wifi.mode ap \ipv4.method shared \wifi-sec.key-mgmt wpa-psk \wifi-sec.psk "88888888"
...
![image](EdgePLC BL246说明书V1.1-images/image29.png)

也可以使用图形用户界面来设置热点配置

输入sudo nmtui指令进入图形界面，选择Edit a connection,再选择Add进入创建网络界面。

![image](EdgePLC BL246说明书V1.1-images/image28.png)
![image](EdgePLC BL246说明书V1.1-images/image27.png)

选择Wi-Fi进入网络配置设置界面，在Mode处选择Access Point即是热点模式，按需求设置相关配置，OK保存后使用启动指令nmcli connection up 设置的连接名（Profile name） 即可开启热点。

![image](EdgePLC BL246说明书V1.1-images/image26.png)

![image](EdgePLC BL246说明书V1.1-images/image25.png)
...
![image](EdgePLC BL246说明书V1.1-images/image24.png)
...
![image](EdgePLC BL246说明书V1.1-images/image23.png)
...
![image](EdgePLC BL246说明书V1.1-images/image21.png)

观察输出结果中的 READ 行，查看带宽（bw）数值。若无报错且有速度数据输出，说明读取功能正常。则硬盘本身功能正常。

#### 2.14.2 Hailo算力模块

本设备支持通过 M.2 接口扩展 Hailo 算力模块，以提供高性能、低功耗的边缘 AI 推理能力。以下是Hailo-8L模块的驱动配置及状态检测规范。
...
![image](EdgePLC BL246说明书V1.1-images/image20.png)

也可执行以下命令查看系统内核日志，确认是否存在硬件通信记录

dmesg | grep -i hailo

![image](EdgePLC BL246说明书V1.1-images/image19.png)
...
![image](EdgePLC BL246说明书V1.1-images/image18.png)
...
![image](EdgePLC BL246说明书V1.1-images/image17.png)

### 3.2 SSH2登录

在使用网口登录前需设置对应网口的IP。此处以ETH2为例。此处ETH2已连接路由器，获取到的IP为192.168.2.107。电脑IP在2网段。

![image](EdgePLC BL246说明书V1.1-images/image16.png)

点击创建连接，选择协议为SSH2，主机名填写为设备IP：192.168.2.107，端口22，用户名root，点击Connect连接。

![image](EdgePLC BL246说明书V1.1-images/image15.png)

选择接受，即连接成功。

![image](EdgePLC BL246说明书V1.1-images/image14.png)

![image](EdgePLC BL246说明书V1.1-images/image13.png)

![image](EdgePLC BL246说明书V1.1-images/image12.png)
...
将空白Micro SD卡连接至电脑，下载并打开烧录工具Raspberry Pi Imager。
![image](EdgePLC BL246说明书V1.1-images/image10.png)

## 1：选择要烧写的硬件，CM5选择PI5。 2：选择镜像，多个版本选择适合自己的（下面也可以选择格式化或者选择自己的备份的系统）。 3：选择要烧录的盘符，只支持移动盘符（USB扩展的盘符），选我们的SD卡。 4：全部选择好就可以点击NEXT，如果选择是树莓派OS，那么会出现下图，如果不需要个性化设置点“不”，如果之前保存过配置可以直接点“是”，第一次使用时，若需要设置请点“编辑设置”。

## 5:使用全新的系统默认不配置用户名和密码，用户可以直接在配置界面配置用户名和密码，如果不配置则需要再开机后连接键盘鼠标配置用户名和密码。

#### 4.1.2从启动卡启动

烧录完毕后取出MICRO SD卡。将MICRO SD 接入底板MICRO SD 卡卡槽，连接CM5核心，上电即可。
...
先拆除外壳上下两面的四个螺丝，打开上盖，再拔出上侧边盖。移除Y板和X板（若有）。拆X/Y板时，先拔插针部分，把侧边盖往外稍微拨一下可拔出Y1板。

将拨码开关的1和4向ON的方向拨，2和3向相反的方向拨，将跳线帽跳至如图所示位置。

![image](EdgePLC BL246说明书V1.1-images/image8.png)
![image](EdgePLC BL246说明书V1.1-images/image7.png)

将USB_OTG端口的拨码开关(序号5)向上拨码。

![image](EdgePLC BL246说明书V1.1-images/image6.emf)

使用底板上方的Type C 接口进行烧录连接。

![image](EdgePLC BL246说明书V1.1-images/image5.png)

#### 4.2.2识别核心板EMMC为移动硬盘

下载并以管理员权限打开软件rpiboot。关闭杀毒软件以安装驱动程序和启动工具。安装成功之后在安装目录下有一个rpiboot.exe。

![image](EdgePLC BL246说明书V1.1-images/image4.png)

## 1.通过Type C 接口（SLAVE 接口） 转USB接口连接电脑。

## 2.此时连接电脑并且给主板供电，电脑设备管理器中会识别出一个BCMxxx的设备（CM5是BCM2712，CM4是BCM2711）如果驱动没有安装成功，设备是在其他设备中。

![image](EdgePLC BL246说明书V1.1-images/image3.png)

然后运行rpiboot(请勿使用管理员权限运行)，选择对应的可执行程序或者脚本。

![image](EdgePLC BL246说明书V1.1-images/image2.png)

例如连接的是CM5。

## 3.等待运行结束，在我的电脑上面会出现一个新的盘符mmcblk0。

![image](EdgePLC BL246说明书V1.1-images/image100.png)

#### 4.2.3系统烧录

## 1：打开Raspberry Pi Imager，选择要烧写的硬件（前面步骤下载的），CM5选择PI5。

## 2：选择镜像，多个版本选择适合自己的（下面也可以选择格式化或者选择自己的备份的系统）。 3：选择要烧录的盘符，即4.2.1生成的移动盘符（USB扩展的盘符）。 4：全部选择好就可以点击NEXT，如果选择是树莓派OS，那么会出现个性化配置界面，如果不需要点“不”，如果之前配置保存过可以直接点“是”，第一次使用需要设置点“编辑设置”。

![image](EdgePLC BL246说明书V1.1-images/image9.png)

## 5：烧录完毕断开电源，断开和电脑的连接线。

## 6：将拨码开关的2和3向ON的方向拨，1和4向相反的方向拨，再将跳线帽跳至如图所示位置。

![image](EdgePLC BL246说明书V1.1-images/image99.png)
![image](EdgePLC BL246说明书V1.1-images/image98.png)

## 7：将USB_OTG端口的拨码开关（序号5）向下拨码短接到地。

![image](EdgePLC BL246说明书V1.1-images/image97.emf)
...
![image](EdgePLC BL246说明书V1.1-images/image96.png)
![image](EdgePLC BL246说明书V1.1-images/image95.png)

将卡扣垂直向下按压，直至其完全嵌入并锁定于导轨底部，即可完成安装。长导轨卡无需额外卡扣，因其内部已预设专用凹槽结构，可直接实现稳固连接。

![image](EdgePLC BL246说明书V1.1-images/image94.png)
