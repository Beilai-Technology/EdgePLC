# EdgePLC BL235说明书V1.1

![image](EdgePLC BL235说明书V1.1-images/image44.jpeg)
![image](EdgePLC BL235说明书V1.1-images/image44.jpeg)
![image](EdgePLC BL235说明书V1.1-images/image33.png)
...
在工业自动化向“边缘计算+实时控制”深度融合的转型背景下，传统PLC面临智能计算的瓶颈，而通用工业计算机又难以满足高实时性控制的需求。EdgePLC BL235系列工业边缘控制器应运而生，旨在打破IT与OT的融合壁垒，提供真正意义上的“边缘控算一体”解决方案。

BL235系列采用“高性能ARM处理器 + 分布式I/O扩展”的架构，以TI Sitara 系列 AM62x 处理器为核心，提供单核、双核或四核 ARM Cortex-A53和单核 ARM Cortex-M4F的多核架构，在保障毫秒级实时控制的同时，具备强大的本地数据处理能力。

EdgePLC BL235工业边缘控制器深度融合实时控制、边缘智能、协议转换、远程运维与二次开发等功能，支持IEC 61131-3标准编程环境（OpenPLC/NexPLC/CODESYS）、IGH EtherCAT硬实时主站，并可扩展多达32块N系列分布式I/O模块，覆盖DI/DO/AI/AO/温度采集等多种信号类型。软件层面基于Ubuntu 20.04系统，集成Docker、Node-RED、Python/C++开发环境，实现从数据采集、实时分析到智能决策的全流程闭环。
...
![image](EdgePLC BL235说明书V1.1-images/image11.png)
![image](EdgePLC BL235说明书V1.1-images/image142.png)

### 1.3技术参数

| 分类 | 参数 | 描述 |
|---|---|---|
| 系统 | 处理器型号 | TI Sitara AM6232/AM6254，16nm |
| 系统 | 处理器频率 | 1/2/4x ARM Cortex-A53(64bit)，主频 1.4GHz。 1x Cortex-M4F，专用实时处理单元，主频 400MHz。 1x Cortex-R5F，主频 400MHz 备注：Cortex-R5F 主要负责系统启动、资源管理和电源管理功能。 1x PRU-ICSS，2 个 32 位可编程实时单元（PRU0 和 PRU1），主频 333MHz 备注：PRU-ICSS 支持 GPIO、UART、I2C 拓展，不支持工业通讯协议和网口拓展。 |
| 系统 | GPU | 3D GPU：图形加速器，支持 OpenGL 3.x/2.0/1.1、Vulkan 1.2(AM6254 Only) |
| 系统 | 内存 | 512MB/1/2GByte DDR3 |
| 系统 | 存储 | 8/16G NAND FLASH |
| 电源 | 输入电压 | DC ～V |
| 电源 | 功耗 | 正常：240mA@12V（带4G模块），220mA@12V（不带4G模块） 最大：700mA@12V |
| 电源 | 反接防护 | 支持 |
| 网口 | 网口规格 | 2~3*RJ45，3x100M，自适应MDI/MDIX。 |
...
![image](EdgePLC BL235说明书V1.1-images/image131.png)
![image](EdgePLC BL235说明书V1.1-images/image120.png)
...
。
![image](EdgePLC BL235说明书V1.1-images/image109.png)
...
|---|---|---|---|---|---|---|
| 端口号 | 1 | 2 | 3 | 4 | 5 | 6 |
| 名称 | ttyS4-A | ttyS4-B | GND | ttyS7-A | ttyS7-B | GND |
...
使用RS485串口时，将RS485线接至端口上（ttl转485），打开sscom5和mobaxterm对接收发，如RS485-1端口（x90模块），其设备文件为/dev/ttyS4；设置其波特率设为 115200，8N1，无校验位。
...
![image](EdgePLC BL235说明书V1.1-images/image98.png)

串口助手发送数据

![image](EdgePLC BL235说明书V1.1-images/image89.png)

终端界面收到数据

![image](EdgePLC BL235说明书V1.1-images/image88.png)
![image](EdgePLC BL235说明书V1.1-images/image87.png)

按“Ctrl+C”停止。

然后更换x90另外一个ttyS7口继续测试。

![image](EdgePLC BL235说明书V1.1-images/image86.png)

![image](EdgePLC BL235说明书V1.1-images/image85.png)

![image](EdgePLC BL235说明书V1.1-images/image84.png)

![image](EdgePLC BL235说明书V1.1-images/image83.png)

![image](EdgePLC BL235说明书V1.1-images/image82.png)

![image](EdgePLC BL235说明书V1.1-images/image81.png)

![image](EdgePLC BL235说明书V1.1-images/image80.png)

![image](EdgePLC BL235说明书V1.1-images/image79.png)

![image](EdgePLC BL235说明书V1.1-images/image78.png)

![image](EdgePLC BL235说明书V1.1-images/image77.png)

![image](EdgePLC BL235说明书V1.1-images/image76.png)

![image](EdgePLC BL235说明书V1.1-images/image75.png)

![image](EdgePLC BL235说明书V1.1-images/image74.png)

![image](EdgePLC BL235说明书V1.1-images/image73.png)
![image](EdgePLC BL235说明书V1.1-images/image72.png)

![image](EdgePLC BL235说明书V1.1-images/image71.png)
![image](EdgePLC BL235说明书V1.1-images/image70.png)

![image](EdgePLC BL235说明书V1.1-images/image69.png)
![image](EdgePLC BL235说明书V1.1-images/image68.png)

![image](EdgePLC BL235说明书V1.1-images/image67.png)
![image](EdgePLC BL235说明书V1.1-images/image66.png)

![image](EdgePLC BL235说明书V1.1-images/image65.png)
![image](EdgePLC BL235说明书V1.1-images/image64.png)

![image](EdgePLC BL235说明书V1.1-images/image63.png)
![image](EdgePLC BL235说明书V1.1-images/image62.png)

![image](EdgePLC BL235说明书V1.1-images/image61.png)

![image](EdgePLC BL235说明书V1.1-images/image60.png)
![image](EdgePLC BL235说明书V1.1-images/image59.png)

![image](EdgePLC BL235说明书V1.1-images/image58.png)

![image](EdgePLC BL235说明书V1.1-images/image57.png)
![image](EdgePLC BL235说明书V1.1-images/image56.png)

![image](EdgePLC BL235说明书V1.1-images/image55.png)

![image](EdgePLC BL235说明书V1.1-images/image54.png)

![image](EdgePLC BL235说明书V1.1-images/image53.png)
![image](EdgePLC BL235说明书V1.1-images/image52.png)

![image](EdgePLC BL235说明书V1.1-images/image51.png)

![image](EdgePLC BL235说明书V1.1-images/image50.png)

![image](EdgePLC BL235说明书V1.1-images/image49.png)

![image](EdgePLC BL235说明书V1.1-images/image48.png)

![image](EdgePLC BL235说明书V1.1-images/image47.png)

![image](EdgePLC BL235说明书V1.1-images/image46.png)

![image](EdgePLC BL235说明书V1.1-images/image45.png)

![image](EdgePLC BL235说明书V1.1-images/image43.png)

![image](EdgePLC BL235说明书V1.1-images/image42.png)

![image](EdgePLC BL235说明书V1.1-images/image41.png)

![image](EdgePLC BL235说明书V1.1-images/image40.png)

![image](EdgePLC BL235说明书V1.1-images/image39.png)

![image](EdgePLC BL235说明书V1.1-images/image38.png)

### 2.4 LED

![image](EdgePLC BL235说明书V1.1-images/image37.jpeg)
...
![image](EdgePLC BL235说明书V1.1-images/image36.png)
...
![image](EdgePLC BL235说明书V1.1-images/image35.png)
![image](EdgePLC BL235说明书V1.1-images/image34.png)

此时ETH应显示为设定的静态IP地址192.168.1.2。
...
![image](EdgePLC BL235说明书V1.1-images/image32.png)

ping百度：ping 8.8.8.8 ，Ctrl+c结束

![image](EdgePLC BL235说明书V1.1-images/image31.png)
![image](EdgePLC BL235说明书V1.1-images/image30.png)

此时LINK灯亮。

### 2.7 USB接口

![image](EdgePLC BL235说明书V1.1-images/image29.png)
...
![image](EdgePLC BL235说明书V1.1-images/image28.png)
![image](EdgePLC BL235说明书V1.1-images/image27.png)
...
![image](EdgePLC BL235说明书V1.1-images/image26.png)
![image](EdgePLC BL235说明书V1.1-images/image25.png)
...
![image](EdgePLC BL235说明书V1.1-images/image24.png)
![image](EdgePLC BL235说明书V1.1-images/image23.png)
...
![image](EdgePLC BL235说明书V1.1-images/image21.png)

重复B~F操作，没有问题说明USB端口正常。

![image](EdgePLC BL235说明书V1.1-images/image20.png)
![image](EdgePLC BL235说明书V1.1-images/image19.png)

### 2.8 HDMI接口

![image](EdgePLC BL235说明书V1.1-images/image18.png)

HDMI接口如图所示。支持HDMI 1.4和HDMI 2.0标准。系统默认支持的分辨率为1920x1080@60fps，最高支持HDMI显示分辨率为 4K。

将HDMI连接设备和显示器，此时显示器应显示。若没有显示可尝试重启设备。

![image](EdgePLC BL235说明书V1.1-images/image17.png)

### 2.9调试串口

![image](EdgePLC BL235说明书V1.1-images/image16.png)

调试接口如图。可通过该端口进入设备系统。

### 2.10 SIM卡插槽

![image](EdgePLC BL235说明书V1.1-images/image15.png)

SIM卡槽如图所示。

### 2.11 SD卡插槽

![image](EdgePLC BL235说明书V1.1-images/image14.png)
...
![image](EdgePLC BL235说明书V1.1-images/image13.png)
![image](EdgePLC BL235说明书V1.1-images/image12.png)
...
![image](EdgePLC BL235说明书V1.1-images/image10.png)
![image](EdgePLC BL235说明书V1.1-images/image9.png)
...
fio --filename=/dev/mmcblk1p --ioengine=psync --rw=write --bs=1024k --size=1G --numjobs=1 --thread --group_reporting --name=write_job --ramp_time=1 --direct=1

可以看到工作状态下的（负载）写入的速度。

![image](EdgePLC BL235说明书V1.1-images/image8.png)
![image](EdgePLC BL235说明书V1.1-images/image7.png)
...
fio --filename=/dev/mmcblk1p --ioengine=psync --rw=read --bs=1024k --size=1G --numjobs=1 --thread --group_reporting --name=read_job --ramp_time=1 --direct=1

可以看到工作状态下读取的速度。

![image](EdgePLC BL235说明书V1.1-images/image6.png)
![image](EdgePLC BL235说明书V1.1-images/image5.png)
...
![image](EdgePLC BL235说明书V1.1-images/image4.png)
...
![image](EdgePLC BL235说明书V1.1-images/image3.png)
![image](EdgePLC BL235说明书V1.1-images/image2.png)

stty -F /dev/ttyUSB1 ispeed 115200 ospeed 115200 cs8 raw -echo //设置串口

![image](EdgePLC BL235说明书V1.1-images/image1.png)
![image](EdgePLC BL235说明书V1.1-images/image141.png)

查信号 20以上 ：

cat /dev/ttyUSB1 & echo -e "AT+CSQ\r" > /dev/ttyUSB1（输入1/2遍）

![image](EdgePLC BL235说明书V1.1-images/image140.png)
![image](EdgePLC BL235说明书V1.1-images/image139.png)

查是4G模块否能正常和SIM卡通讯：

echo -e "AT+CPIN?\r" > /dev/ttyUSB1

![image](EdgePLC BL235说明书V1.1-images/image138.png)
![image](EdgePLC BL235说明书V1.1-images/image137.png)
...
![image](EdgePLC BL235说明书V1.1-images/image136.png)
![image](EdgePLC BL235说明书V1.1-images/image135.png)
...
![image](EdgePLC BL235说明书V1.1-images/image134.png)
![image](EdgePLC BL235说明书V1.1-images/image133.png)
...
![image](EdgePLC BL235说明书V1.1-images/image132.png)
![image](EdgePLC BL235说明书V1.1-images/image130.png)
...
![image](EdgePLC BL235说明书V1.1-images/image129.png)
![image](EdgePLC BL235说明书V1.1-images/image128.png)
...
![image](EdgePLC BL235说明书V1.1-images/image127.png)
![image](EdgePLC BL235说明书V1.1-images/image126.png)

ifconfig #查看wlan0有无IP

![image](EdgePLC BL235说明书V1.1-images/image125.png)
![image](EdgePLC BL235说明书V1.1-images/image124.png)

最后ping百度测试：

ping -4 www.baidu.com （百度域名不一定成功转IP，使用百度IP）

![image](EdgePLC BL235说明书V1.1-images/image123.png)
![image](EdgePLC BL235说明书V1.1-images/image122.png)
...
![image](EdgePLC BL235说明书V1.1-images/image121.png)
![image](EdgePLC BL235说明书V1.1-images/image119.png)

![image](EdgePLC BL235说明书V1.1-images/image118.png)

重新测试杀掉旧进程即可

![image](EdgePLC BL235说明书V1.1-images/image117.png)
...
![image](EdgePLC BL235说明书V1.1-images/image116.png)
...
![image](EdgePLC BL235说明书V1.1-images/image115.png)

### 3.2 SSH2登录

在使用网口登录前需设置对应网口的IP。此处以ETH2为例。此处ETH2已连接路由器，获取到的IP为192.168.2.107。电脑IP在2网段。

![image](EdgePLC BL235说明书V1.1-images/image114.png)

点击创建连接，选择协议为SSH2，主机名填写为设备IP：192.168.2.107，端口22，用户名root，点击Connect连接。

![image](EdgePLC BL235说明书V1.1-images/image113.png)

选择接受，即连接成功。

![image](EdgePLC BL235说明书V1.1-images/image112.png)

## 4.系统烧录

### 4.1 Micro SD卡启动

![image](EdgePLC BL235说明书V1.1-images/image111.png)

![image](EdgePLC BL235说明书V1.1-images/image110.png)

![image](EdgePLC BL235说明书V1.1-images/image108.png)

![image](EdgePLC BL235说明书V1.1-images/image107.png)

![image](EdgePLC BL235说明书V1.1-images/image106.png)

![image](EdgePLC BL235说明书V1.1-images/image105.png)

![image](EdgePLC BL235说明书V1.1-images/image104.png)

![image](EdgePLC BL235说明书V1.1-images/image103.png)

![image](EdgePLC BL235说明书V1.1-images/image102.png)

![image](EdgePLC BL235说明书V1.1-images/image101.png)

![image](EdgePLC BL235说明书V1.1-images/image100.png)

![image](EdgePLC BL235说明书V1.1-images/image99.png)

![image](EdgePLC BL235说明书V1.1-images/image97.png)

![image](EdgePLC BL235说明书V1.1-images/image96.png)

![image](EdgePLC BL235说明书V1.1-images/image95.png)

![image](EdgePLC BL235说明书V1.1-images/image94.png)

![image](EdgePLC BL235说明书V1.1-images/image93.png)
...
![image](EdgePLC BL235说明书V1.1-images/image92.png)
![image](EdgePLC BL235说明书V1.1-images/image91.png)

将卡扣垂直向下按压，直至其完全嵌入并锁定于导轨底部，即可完成安装。长导轨卡无需额外卡扣，因其内部已预设专用凹槽结构，可直接实现稳固连接。

![image](EdgePLC BL235说明书V1.1-images/image90.png)
