<figure>
<img
src="EdgePLC BL233说明书V1.1-images/image2.jpeg"
...
<figure>
<img
src="EdgePLC BL233说明书V1.1-images/image1.png"
...
感谢您使用深圳市钡铼技术有限公司的BL233系列，阅读本产品说明书能让您快速掌握本产品的功能和使用方法。
...
BL233系列工业边缘控制器应运而生，旨在打破IT与OT的融合壁垒，提供真正意义上的“边缘控算一体”解决方案。

BL233系列采用“高性能ARM处理器 + 分布式I/O扩展”的架构，以全志科技
T113-i双核 ARM Cortex-A7为核心 ，提供玄铁 C906 RISC-V + HiFi4 DSP
多核处理器架构，在保障毫秒级实时控制的同时，具备强大的本地数据处理能力。

EdgePLC
BL233工业边缘控制器深度融合实时控制、边缘智能、协议转换、远程运维与二次开发等功能，支持IEC
61131-3标准编程环境（OpenPLC/NexPLC）、IGH
...
BL233系列工业边缘控制器专为智能产线控制、储能EMS、光伏逆变器管理等“控制+计算”协同场景设计，通过将智能分析下沉至设备边缘，它不仅实现了控制逻辑的精准执行，更完成了数据价值的就地转化与智能决策，助力企业构建更敏捷、更智能、更高效的下一代工业控制系统，从容应对智能制造的未来挑战。
...
<tbody>
<tr>
<td rowspan="4" style="text-align: center;">系统</td>
<td style="text-align: center;">型号</td>
<td>T113-i：2*ARM Cortex-A7，1*玄铁C906 RISC-V(64bit）</td>
</tr>
<tr>
...
<td>DDR3 256/512MByte，1GByte</td>
</tr>
<tr>
<td style="text-align: center;">存储</td>
<td>eMMC 4/8G，NAND FLASH 256MByte</td>
</tr>
<tr>
...
<td><p>正常：280mA@12V（带4G模块），220mA@12V（不带4G模块）</p>
<p>最大：700mA@12V</p></td>
</tr>
<tr>
...
<tr>
<td rowspan="2" style="text-align: center;">N板数字输出（选配）</td>
<td style="text-align: center;">数量</td>
<td>16/32通道</td>
</tr>
<tr>
...
<td>-40～85℃/0~70℃，35～75% RH</td>
</tr>
<tr>
<td style="text-align: center;">存储温度、湿度</td>
<td>-40～85℃，35～75% RH</td>
</tr>
<tr>
...
|  BL233   | 2x100M  |    2    |    0     |      1      | 38x92x110mm |
|  BL233A  | 3x100M  |    2    |    1     |      1      | 38x92x110mm |
...
<img
src="EdgePLC BL233说明书V1.1-images/image6.png"
style="width:3.14375in;height:1.87847in" alt="EdgePLC A款 (10)" /><img
src="EdgePLC BL233说明书V1.1-images/image7.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image8.png"
...
<td style="text-align: center;">ttyAS4-A</td>
<td style="text-align: center;">ttyAS4-B</td>
<td style="text-align: center;">GND</td>
<td style="text-align: center;">ttyAS3-A</td>
<td style="text-align: center;">ttyAS3-B</td>
<td style="text-align: center;">GND</td>
</tr>
</tbody>
</table>
...
使用RS485串口时，将RS485线接至端口上（ttl转485），打开sscom5和mobaxterm对接收发，如RS485-2端口（x90模块），其设备文件为/dev/ttyAS3；设置其波特率设为
115200，8N1，无校验位。

stty -F /dev/ttyAS3 ispeed 115200 ospeed 115200 cs8

echo 12345 /> /dev/ttyAS3 //通过RS485-2端口发送数据

cat /dev/ttyAS3 //等待查看接收到的数据

串口助手收到数据

<img
src="EdgePLC BL233说明书V1.1-images/image9.png"
style="width:5.77153in;height:0.22708in" />

串口助手发送数据

<img
src="EdgePLC BL233说明书V1.1-images/image10.png"
style="width:5.77153in;height:0.52986in" />

终端界面收到数据

<img
src="EdgePLC BL233说明书V1.1-images/image11.png"
style="width:5.7625in;height:0.48264in" />

按“Ctrl+C”停止。

然后更换x90另外一个ttyAS4口继续测试。
...
<img
src="EdgePLC BL233说明书V1.1-images/image12.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image13.png"
style="width:5.76389in;height:0.31875in" />

Cangaroo工具收到数据

<img
src="EdgePLC BL233说明书V1.1-images/image14.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image15.png"
style="width:5.76181in;height:0.16875in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image16.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image17.png"
style="width:5.76181in;height:0.44861in" />

<img
src="EdgePLC BL233说明书V1.1-images/image19.png"
style="width:5.76181in;height:3.84097in" />

通过左边文件夹页面在usr/demo/文件夹下，新建ion文件夹，把N板识别文件复制进去

<img
src="EdgePLC BL233说明书V1.1-images/image21.png"
style="width:5.76181in;height:2.15139in" />

对BEILAI_N_PLC_233_V1.0_20260520.bin执行chmod +x
BEILAI_N_PLC_233_V1.0_20260520.bin。然后安装软件。

root@bliiot:/# cd /usr/demo/ion

root@bliiot:/# chmod +x BEILAI_N_PLC_233_V1.0_20260520.bin

root@bliiot:/# ./BEILAI_N_PLC_233_V1.0_20260520.bin
...
<img
src="EdgePLC BL233说明书V1.1-images/image23.png"
style="width:5.7625in;height:1.04375in" />

<img
src="EdgePLC BL233说明书V1.1-images/image25.png"
style="width:5.76458in;height:4.58125in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image27.png"
style="width:5.7625in;height:0.30278in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image29.png"
style="width:5.7625in;height:0.44722in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image31.png"
style="width:5.76319in;height:4.48056in" />

使用ion help指令，发现量程是不可设置的，和DO类似
...
<img
src="EdgePLC BL233说明书V1.1-images/image33.png"
style="width:5.76319in;height:0.29306in" />

将DI31（即为31通道）短接

<img
src="EdgePLC BL233说明书V1.1-images/image35.png"
style="width:5.76389in;height:4.64861in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image37.png"
style="width:5.76111in;height:1.24931in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image38.png"
style="width:5.76806in;height:0.25625in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image39.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image40.png"
style="width:5.76111in;height:1.33889in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image41.png"
style="width:5.76111in;height:1.54514in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image43.png"
style="width:5.76111in;height:1.5in" />

对应的N3083单端输入电压类似。

<img
src="EdgePLC BL233说明书V1.1-images/image45.png"
style="width:5.76667in;height:1.35694in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image47.png"
style="width:5.76389in;height:0.88819in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image48.png"
style="width:5.7625in;height:0.97083in" />

<img
src="EdgePLC BL233说明书V1.1-images/image49.png"
style="width:5.76458in;height:0.79167in" />

<img
src="EdgePLC BL233说明书V1.1-images/image50.png"
style="width:5.76597in;height:0.94653in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image51.png"
style="width:5.76667in;height:1.52639in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image52.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image53.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image54.jpeg"
...
<img
src="EdgePLC BL233说明书V1.1-images/image55.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image56.png"
style="width:5.76111in;height:3.80903in" />

此时ETH3应显示为设定的静态IP地址192.168.1.70。
...
<img
src="EdgePLC BL233说明书V1.1-images/image57.png"
style="width:5.76319in;height:1.17917in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image58.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image59.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image60.png"
style="width:5.76111in;height:0.66458in" />
...
7.  可以看到读取的速度。
    ...
    <img
    src="EdgePLC BL233说明书V1.1-images/image61.png"
    style="width:5.76597in;height:0.67639in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image62.png"
style="width:5.76806in;height:0.44514in" />

## 2.7 HDMI接口

<img
src="EdgePLC BL233说明书V1.1-images/image63.png"
...
将HDMI连接设备和显示器，此时显示器应显示T113的图标。若没有显示可尝试重启设备。

## 2.8 调试串口

<img
src="EdgePLC BL233说明书V1.1-images/image64.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image65.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image66.png"
style="width:3.41458in;height:1.27431in"
alt="c8c1b31cf4c96155d490e919f7fb7263_compress" />

SD卡槽如图所示，支持FAT32格式SD卡，以emmc烧录为例。
...
<img
src="EdgePLC BL233说明书V1.1-images/image67.png"
style="width:5.76042in;height:2.24583in" />

2.  系统识别到存储介质包含两个有效大分区，后续读写性能测试将限定在SD卡路径下进行”，并且可直观读取到该存储设备的实际物理容量。

3.  然后输入以下指令测试写入：

fio --filename=/dev/mmcblk1p1 --ioengine=psync --rw=write --bs=1024k
--size=1G --numjobs=1 --thread --group_reporting --name=write_job
...
4.  可以看到工作状态下的（负载）写入的速度。
    ...
    <img
    src="EdgePLC BL233说明书V1.1-images/image68.png"
...
fio --filename=/dev/mmcblk1p1 --ioengine=psync --rw=read --bs=1024k
...
7.  可以看到工作状态下读取的速度。
    ...
    <img
    src="EdgePLC BL233说明书V1.1-images/image69.png"
    style="width:5.76597in;height:0.45069in" />

    A~F步骤都正常说明这个SD卡接口没有问题。

8.  测试完同步数据，重新测试需要清除缓存
...
<img
src="EdgePLC BL233说明书V1.1-images/image70.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image71.png"
style="width:5.76111in;height:2.10278in" />

stty -F /dev/ttyUSB1 ispeed 115200 ospeed 115200 cs8 raw -echo
//设置串口

<img
src="EdgePLC BL233说明书V1.1-images/image72.png"
style="width:5.76806in;height:0.27014in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image73.png"
style="width:5.76736in;height:0.87778in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image74.png"
style="width:5.76389in;height:0.53542in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image75.png"
style="width:5.76736in;height:0.56042in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image76.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image77.png"
style="width:5.76319in;height:0.97361in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image78.png"
style="width:5.76389in;height:0.44028in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image79.png"
style="width:5.76319in;height:1.6625in" />

ifconfig /#查看wlan0有无IP

<img
src="EdgePLC BL233说明书V1.1-images/image80.png"
style="width:5.76389in;height:1.00764in" />
...
<img
src="EdgePLC BL233说明书V1.1-images/image81.png"
style="width:5.76111in;height:1.15347in" />
...
root@BL233-bliiot:~# ls /dev/rtc/*

/dev/rtc /dev/rtc0

root@BL233-bliiot:~# dmesg /| grep rtc0
...
root@BL233-bliiot:~# date

Thu 23 Apr 10:28:42 BST 2026

设置RTC时间：

root@BL233-bliiot:~# sudo hwclock --set --date="2026-4-23 17:30:00"

root@BL233-bliiot:~# sudo hwclock -r

同步RTC时钟至系统时钟：

root@BL233-bliiot:~# sudo hwclock -s

同步系统时钟到 RTC 的时钟：

root@BL233-bliiot:~# sudo hwclock -w
...
root@BL233:~#usr/demo/rjgt# ./rigt102
...
<img
src="EdgePLC BL233说明书V1.1-images/image82.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image83.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image91.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image92.png"
style="width:4.62986in;height:3.63125in" />

“量产卡”制作完成后，状态栏将会打印如下信息。

<img
src="EdgePLC BL233说明书V1.1-images/image93.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image94.png"
...
<img
src="EdgePLC BL233说明书V1.1-images/image95.png"
...
从Linux系统启动卡启动，进入设备文件系统，执行如下命令，将"/dev/mmcblk1p6"分区格式化后，重新挂载。挂载成功后，即可在"/mnt/sdcard/mmcblk1p6/"目录下进行文件读写。
...
<img
src="EdgePLC BL233说明书V1.1-images/image98.png"
