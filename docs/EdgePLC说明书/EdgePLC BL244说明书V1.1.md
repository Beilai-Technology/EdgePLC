# EdgePLC BL244说明书V1.1

![image](EdgePLC BL244说明书V1.1-images/image44.jpeg)
![image](EdgePLC BL244说明书V1.1-images/image44.jpeg)
![image](EdgePLC BL244说明书V1.1-images/image33.png)
...
在工业自动化向“AI边缘计算+实时控制”深度融合的转型背景下，传统PLC面临智能计算的瓶颈，而通用工业计算机又难以满足高实时性控制的需求。EdgePLC BL244系列工业AI边缘控制器应运而生，旨在打破IT与OT的融合壁垒，提供真正意义上的“边缘AI控算一体”解决方案。

BL244系列采用“高性能ARM处理器 + 分布式I/O扩展”的架构，以瑞芯微RK3576J/RK3576为核心，集成6TOPS算力的专用NPU，支持四核Cortex-A72 + 四核Cortex-A53 + 三核Cortex-M0的异构计算，在保障毫秒级实时控制的同时，具备强大的本地AI推理与数据处理能力。

EdgePLC BL244工业AI边缘控制器深度融合实时控制、AI边缘智能、协议转换、远程运维与二次开发等功能，支持IEC 61131-3标准编程环境（OpenPLC/NexPLC/CODESYS）、IGH EtherCAT硬实时主站，并可扩展多达32块N系列分布式I/O模块，覆盖DI/DO/AI/AO/温度采集等多种信号类型。软件层面基于Ubuntu 20.04系统，集成Docker、Node-RED、Python/C++开发环境，以及YOLOv5/8+OpenCV等AI视觉工具栈，实现从数据采集、实时分析到智能决策的全流程闭环。
...
![image](EdgePLC BL244说明书V1.1-images/image11.png)
![image](EdgePLC BL244说明书V1.1-images/image116.png)

### 1.3技术参数

| 分类 | 参数 | 描述 |
|---|---|---|
| 系统 | 处理器型号 | 瑞芯微 RK3576J/RK3576，64bit，8nm |
| 系统 | 处理器频率 | 4x ARM Cortex-A72 RK3576J 主频：normal mode 1.6GHz，overdrive mode 2.1GHz RK3576 主频：2.2GHz 备注：为保障处理器使用寿命，满足更多工业应用场景要求，我司已将RK3576J/RK3576 处理器 Cortex-A72 核心最高主频默认配置为 1.6GHz。 |
| 系统 | 处理器频率 | 4x ARM Cortex-A53 RK3576J 主频：normal mode 1.4 GHz，overdrive mode 1.9 GHz RK3576 主频：2.0GHz 备注：为保障处理器使用寿命，满足更多工业应用场景要求，我司已将RK3576J/RK3576 处理器 Cortex-A53 核心最高主频默认配置为 1.4GHz。 |
| 系统 | 处理器频率 | 1x ARM Cortex-M0主频：400MHz |
| 系统 | GPU | GPU：Mali-G52 MC3，支持 OpenGL ES 1.1/2.0/3.2、OpenCL 2.0、Vulkan 1.1 |
| 系统 | GPU | ISP:16M，支持HDR、3A、CAC、3DNR、2DNR等 |
| 系统 | GPU | Decoder：支持8K@30fps/4K@120fps H.265、4K@60fps H.264 Encoder：支持4K@60fps H.265/H.264 |
| 系统 | NPU | 6TOPS 支持INT4/INT8/INT16/BF16/TF32 支持TensorFlow/PyTorch/Caffe/MXNet深度学习框架 |
| 系统 | 内存 | 2/4/8GByte LPDDR4X |
| 系统 | 存储 | 16/32/64GByte eMMC |
| 电源 | 输入电压 | DC 12～24V |
...
| USB接口 | 数量 | 1*micro USB，2*USB 3.2 HOST |
| USB接口 | 传输速度 | 最大104 MB/s |
| USB接口 | 输出功率 | 100mA@5V |
| SD卡座 | 数量 | 1 |
...
| 其他 | 防护等级 | IP30 |
| 其他 | 安装方式 | DIN35导轨安装 |
| 其他 | 系统 | Buildroot-2024.02(Linux-6.1.115、Linux-RT-6.1.115) Ubuntu 22.04 |
...
|---|---|---|---|---|---|
| BL244 |  | 2 | 0 | 1 | 38x92x110mm |
| BL24A |  | 2 | 1 | 1 | 38x92x110mm |
...
![image](EdgePLC BL244说明书V1.1-images/image105.png)
![image](EdgePLC BL244说明书V1.1-images/image94.png)
...
。
![image](EdgePLC BL244说明书V1.1-images/image91.png)
...
|---|---|---|---|---|---|---|
| 端口号 | 1 | 2 | 3 | 4 | 5 | 6 |
| 名称 | ttyS1-A | ttyS1-B | GND | ttyS8-A | ttyS8-B | GND |
...
使用RS485串口时，将RS485线接至端口上（ttl转485），打开sscom5和mobaxterm对接收发，如RS485-1端口（x90模块），其设备文件为/dev/ttyS1；设置其波特率设为 115200，8N1，无校验位。
...
![image](EdgePLC BL244说明书V1.1-images/image90.png)

串口助手发送数据

![image](EdgePLC BL244说明书V1.1-images/image89.png)

终端界面收到数据

![image](EdgePLC BL244说明书V1.1-images/image88.png)

按“Ctrl+C”停止。

然后更换x90另外一个ttyS8口继续测试。

![image](EdgePLC BL244说明书V1.1-images/image87.png)

![image](EdgePLC BL244说明书V1.1-images/image86.png)
![image](EdgePLC BL244说明书V1.1-images/image85.png)

![image](EdgePLC BL244说明书V1.1-images/image84.png)

![image](EdgePLC BL244说明书V1.1-images/image83.png)
![image](EdgePLC BL244说明书V1.1-images/image82.png)

![image](EdgePLC BL244说明书V1.1-images/image81.png)
![image](EdgePLC BL244说明书V1.1-images/image80.png)

![image](EdgePLC BL244说明书V1.1-images/image79.png)

![image](EdgePLC BL244说明书V1.1-images/image78.png)

![image](EdgePLC BL244说明书V1.1-images/image77.png)

![image](EdgePLC BL244说明书V1.1-images/image76.png)

![image](EdgePLC BL244说明书V1.1-images/image75.png)

![image](EdgePLC BL244说明书V1.1-images/image81.png)

![image](EdgePLC BL244说明书V1.1-images/image74.png)
![image](EdgePLC BL244说明书V1.1-images/image73.png)
...
![image](EdgePLC BL244说明书V1.1-images/image72.png)
![image](EdgePLC BL244说明书V1.1-images/image71.png)

![image](EdgePLC BL244说明书V1.1-images/image70.png)
![image](EdgePLC BL244说明书V1.1-images/image69.png)

通过左边文件夹页面在文件夹下，把N板识别文件复制进去

![image](EdgePLC BL244说明书V1.1-images/image68.png)
![image](EdgePLC BL244说明书V1.1-images/image67.png)

对BEILAI_N_PLC_244_V1.0_202605.bin执行chmod +x BEILAI_N_PLC_244_V1.0_202605.bin。然后安装软件。

root@bliiot:/# chmod +x BEILAI_N_PLC_244_V1.0_202605.bin

root@bliiot:/# ./BEILAI_N_PLC_244_V1.0_202605.bin
...
这里以N2162为准（16路DO模块NPN模块），ion show查看IO板信息。ion help查看命令帮助。

root@bliiot:/# ion help

输入ion show查看信息。

![image](EdgePLC BL244说明书V1.1-images/image66.png)

![image](EdgePLC BL244说明书V1.1-images/image65.png)
...
![image](EdgePLC BL244说明书V1.1-images/image64.png)

root@bliiot:/# ion set 1000 10 //通过address设置输出10

root@bliiot:/# ion get 1000 //通过address查看

![image](EdgePLC BL244说明书V1.1-images/image63.png)
...
以N1321为例（路DI模块湿节点），DI模块为例，输入ion show查看信息。

湿节点测试(带电干结点)：以N1321为例（型）
...
![image](EdgePLC BL244说明书V1.1-images/image62.png)
...
![image](EdgePLC BL244说明书V1.1-images/image61.png)

将DI15（即为15通道）短接

![image](EdgePLC BL244说明书V1.1-images/image60.png)

观察N板灯亮情况，对应DI短接形成回路灯亮。对应的N1162、1、1322类似。

干接点以N1163、N1323为例，短接即可和上述类似。

![image](EdgePLC BL244说明书V1.1-images/image59.png)

![image](EdgePLC BL244说明书V1.1-images/image58.png)

![image](EdgePLC BL244说明书V1.1-images/image57.png)

![image](EdgePLC BL244说明书V1.1-images/image56.png)

![image](EdgePLC BL244说明书V1.1-images/image55.png)

![image](EdgePLC BL244说明书V1.1-images/image54.png)

![image](EdgePLC BL244说明书V1.1-images/image53.png)

![image](EdgePLC BL244说明书V1.1-images/image52.png)

![image](EdgePLC BL244说明书V1.1-images/image51.png)

![image](EdgePLC BL244说明书V1.1-images/image50.png)

![image](EdgePLC BL244说明书V1.1-images/image49.png)

![image](EdgePLC BL244说明书V1.1-images/image48.png)

![image](EdgePLC BL244说明书V1.1-images/image47.png)

![image](EdgePLC BL244说明书V1.1-images/image46.png)

### 2.4 LED

![image](EdgePLC BL244说明书V1.1-images/image45.jpeg)
...
![image](EdgePLC BL244说明书V1.1-images/image43.png)
...
![image](EdgePLC BL244说明书V1.1-images/image42.png)
...
![image](EdgePLC BL244说明书V1.1-images/image41.png)

此时LINK灯亮。

## 2. USB接口

![image](EdgePLC BL244说明书V1.1-images/image40.png)
...
![image](EdgePLC BL244说明书V1.1-images/image39.png)
...
![image](EdgePLC BL244说明书V1.1-images/image38.png)
...
![image](EdgePLC BL244说明书V1.1-images/image37.png)
...
![image](EdgePLC BL244说明书V1.1-images/image36.png)

## 2.HDMI接口

![image](EdgePLC BL244说明书V1.1-images/image35.png)

HDMI接口如图所示。支持HDMI 1.4和HDMI 2.0标准。系统默认支持的分辨率为1920x1080@60fps，最高支持HDMI显示分辨率为 4K。

将HDMI连接设备和显示器，此时显示器应显示桌面系统。若没有显示可尝试重启设备。

![image](EdgePLC BL244说明书V1.1-images/image34.png)

## 2.调试串口

![image](EdgePLC BL244说明书V1.1-images/image32.png)

调试接口如图。可通过该端口进入设备系统。

## 2. SIM卡插槽

![image](EdgePLC BL244说明书V1.1-images/image31.png)

SIM卡槽如图所示。

### 2.1SD卡插槽

![image](EdgePLC BL244说明书V1.1-images/image30.png)
...
![image](EdgePLC BL244说明书V1.1-images/image29.png)
...
![image](EdgePLC BL244说明书V1.1-images/image28.png)
...
![image](EdgePLC BL244说明书V1.1-images/image27.png)
...
![image](EdgePLC BL244说明书V1.1-images/image26.png)
...
![image](EdgePLC BL244说明书V1.1-images/image25.png)

stty -F /dev/ttyUSB1 ispeed 115200 ospeed 115200 cs8 raw -echo //设置串口

![image](EdgePLC BL244说明书V1.1-images/image24.png)

查信号 20以上 ：

cat /dev/ttyUSB1 & echo -e "AT+CSQ\r" > /dev/ttyUSB1（输入1/2遍）

![image](EdgePLC BL244说明书V1.1-images/image23.png)

查是4G模块否能正常和SIM卡通讯：

echo -e "AT+CPIN?\r" > /dev/ttyUSB1

![image](EdgePLC BL244说明书V1.1-images/image21.png)
...
![image](EdgePLC BL244说明书V1.1-images/image20.png)
...
![image](EdgePLC BL244说明书V1.1-images/image19.png)
...
![image](EdgePLC BL244说明书V1.1-images/image18.png)
...
![image](EdgePLC BL244说明书V1.1-images/image17.png)
...
![image](EdgePLC BL244说明书V1.1-images/image16.png)

ifconfig #查看wlan0有无IP

![image](EdgePLC BL244说明书V1.1-images/image15.png)

最后ping百度测试：

ping www.baidu.com （百度域名不一定成功转IP，使用百度IP）

![image](EdgePLC BL244说明书V1.1-images/image14.png)
...
![image](EdgePLC BL244说明书V1.1-images/image13.png)
...
![image](EdgePLC BL244说明书V1.1-images/image12.png)
...
![image](EdgePLC BL244说明书V1.1-images/image10.png)
...
![image](EdgePLC BL244说明书V1.1-images/image9.png)
...
![image](EdgePLC BL244说明书V1.1-images/image8.png)

### 3.2 SSH2登录

在使用网口登录前需设置对应网口的IP。此处以ETH2为例。此处ETH2已连接路由器，获取到的IP为192.168.2.107。电脑IP在2网段。

![image](EdgePLC BL244说明书V1.1-images/image7.png)

点击创建连接，选择协议为SSH2，主机名填写为设备IP：192.168.2.107，端口22，用户名root，点击Connect连接。

![image](EdgePLC BL244说明书V1.1-images/image6.png)

选择接受，即连接成功。

![image](EdgePLC BL244说明书V1.1-images/image5.png)
...
![image](EdgePLC BL244说明书V1.1-images/image4.png)

找到“System”项中添加“USER_DISK_FS=NTFS”内容，否则会导致烧录失败。

![image](EdgePLC BL244说明书V1.1-images/image3.png)

将空白Micro SD卡连接至电脑，打开“SDDiskTool_v1.69”文件夹，右键"SD_Firmware_Tool.exe"点击“以管理员身份运行(A)”。

![image](EdgePLC BL244说明书V1.1-images/image2.png)

在“第一步：选择可移动设备”中选择可移动磁盘设备，然后点击“恢复磁盘”进行格式化，如下图所示。

![image](EdgePLC BL244说明书V1.1-images/image1.png)

请确认所选的可移动磁盘设备无误，在弹出窗口中点击“是(Y)”进行格式化。

![image](EdgePLC BL244说明书V1.1-images/image115.png)

![image](EdgePLC BL244说明书V1.1-images/image114.png)

等待格式化完成后，在弹出窗口中点击“确定”。

![image](EdgePLC BL244说明书V1.1-images/image113.png)

勾选“SD启动”选项，点击“选择固件”选择目标系统镜像文件，点击“开始创建”，在弹出窗口中点击“是(Y)”，制作SD启动卡。

![image](EdgePLC BL244说明书V1.1-images/image112.png)

![image](EdgePLC BL244说明书V1.1-images/image111.png)

![image](EdgePLC BL244说明书V1.1-images/image110.png)

在弹出的窗口中点击“确定”，此时 SD 启动卡制作完成。

![image](EdgePLC BL244说明书V1.1-images/image109.png)

#### 4.1.2从启动卡启动

将启动卡插至设备Micro SD卡槽，然后将设备上电，系统将从启动卡启动后自动登录root用户，串口调试终端会打印如下类似启动信息。"Bootdev(atags): mmc 1"表示从Micro SD卡启动。

![image](EdgePLC BL244说明书V1.1-images/image108.png)
...
![image](EdgePLC BL244说明书V1.1-images/image107.png)

请确认所选的可移动磁盘设备无误，在弹出窗口中点击“是(Y)”进行格式化。

![image](EdgePLC BL244说明书V1.1-images/image115.png)

![image](EdgePLC BL244说明书V1.1-images/image106.png)
...
![image](EdgePLC BL244说明书V1.1-images/image104.png)

![image](EdgePLC BL244说明书V1.1-images/image103.png)

![image](EdgePLC BL244说明书V1.1-images/image102.png)

点击“是”。

![image](EdgePLC BL244说明书V1.1-images/image101.png)

开始烧写系统。

![image](EdgePLC BL244说明书V1.1-images/image100.png)

提示创建成功。

![image](EdgePLC BL244说明书V1.1-images/image99.png)

#### 4.2.2系统烧录

将制作好的SD卡插至设备Micro SD卡槽，上电后将从SD卡启动，并自动固化系统至eMMC中。等待约5分钟。当系统固化完成后，设备将自动掉电。串口打印如下。

![image](EdgePLC BL244说明书V1.1-images/image98.png)

若为Ubuntu20.04系统则会弹出下图：

![image](EdgePLC BL244说明书V1.1-images/image97.png)

取出SD卡，波特率设置为115200，重新上电，设备将从eMMC启动系统，系统启动后自动登录root用户，串口调试终端会打印如下类似启动信息。"Bootdev(atags)：mmc 0"表示从eMMC启动。

![image](EdgePLC BL244说明书V1.1-images/image96.png)

## 5.导轨安装

配备导轨卡扣分为。此设计预留了充足的螺丝锁付空间，便于用户进行安装操作。

![image](EdgePLC BL244说明书V1.1-images/image95.png)
![image](EdgePLC BL244说明书V1.1-images/image93.png)

将卡扣垂直向下按压，直至其完全嵌入并锁定于导轨底部，即可完成安装。长导轨卡无需额外卡扣，因其内部已预设专用凹槽结构，可直接实现稳固连接。

![image](EdgePLC BL244说明书V1.1-images/image92.png)
