...
BL241系列工业AI边缘控制器应运而生，旨在打破IT与OT的融合壁垒，提供真正意义上的“边缘AI控算一体”解决方案。

BL241系列采用“高性能ARM处理器 +
分布式I/O扩展”的架构，以瑞芯微RK3568J/RK3568B2为核心，集成1TOPS算力的专用NPU，四核ARM
Cortex-A55的架构，在保障毫秒级实时控制的同时，具备强大的本地AI推理与数据处理能力。

EdgePLC
BL241工业AI边缘控制器深度融合实时控制、AI边缘智能、协议转换、远程运维与二次开发等功能，支持IEC
...
<td style="text-align: center;">瑞芯微 RK3568J/RK3568B2</td>
</tr>
<tr>
<td style="text-align: center;">处理器频率</td>
<td style="text-align: center;">1.8/2GHz</td>
</tr>
<tr>
...
<td style="text-align: center;">1TOPS</td>
</tr>
<tr>
<td style="text-align: center;">GPU</td>
<td style="text-align: left;">Mali-G52-2EE</td>
</tr>
<tr>
...
<td
style="text-align: center;"><p>正常：260mA@12V（带4G模块），220mA@12V（不带4G模块）</p>
<p>最大：800mA@12V</p></td>
</tr>
<tr>
...
<td style="text-align: center;">2~3*RJ45，3x100M，自适应MDI/MDIX。</td>
</tr>
<tr>
...
<td style="text-align: center;"><p>闭合：短接</p>
<p>断开：端开路</p></td>
</tr>
<tr>
<td style="text-align: center;">湿接点</td>
<td style="text-align: center;"><p>逻辑0：0-15VDC</p>
<p>逻辑1：16-24VDC</p></td>
</tr>
<tr>
...
<td style="text-align: center;">Ch1 ~ Ch13</td>
</tr>
<tr>
<td style="text-align: center;">安全性</td>
<td style="text-align: center;">Open、WPA、WPA2</td>
</tr>
<tr>
<td style="text-align: center;">加密</td>
<td style="text-align: center;">AES、TKIP、TKIPAES</td>
</tr>
<tr>
...
<td style="text-align: center;">150Mbps（Max）</td>
</tr>
<tr>
...
<td style="text-align: center;">Ubuntu20.04（Linux-5.10
、Linux-RT-4.19.232）</td>
</tr>
</tbody>
</table>
...
使用RS485串口时，将RS485线接至端口上（ttl转485），打开sscom5和mobaxterm对接收发，如RS485-1端口（x90模块），其设备文件为/dev/ttyS0；设置其波特率设为
115200，8N1，无校验位。
...
以第一通道为例，设定输出19mA，界面显示的数值即为该通道的实际输出值。
...
root@BL241:~#usr/demo/rjgt102# ./rjgt102_rk3568
